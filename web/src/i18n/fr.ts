...
export const fr: Translations = {
    ...
    tt: {
        ...
        summaryStarsEarnedOne: 'Tu as gagné {n} étoile !', summaryStarsEarned: 'Tu as gagné {n} étoiles !',
    ...
    duel: {
        ...
        modeTogetherHint: 'Un seul résultat pour vous deux. Vous vous aidez — personne ne gagne.',
        modeVersus: '⚔️ L’un contre l’autre',
        modeVersusHint: 'Chaque enfant compte pour soi. Mêmes calculs, mêmes chances.',
        playerOne: 'Enfant 1',
        playerTwo: 'Enfant 2',
        ...
        versusDraw: 'Égalité — à force égale !',
        correctOf: '{correct} sur {total} justes',
        again: 'Encore',
        exit: 'Retour',
        recordsNothing: 'Une partie à deux n’est pas enregistrée — elle ne change ni les étoiles ni les progrès.',
    },
    surprise: {
        title: 'Surprends-moi',
    ...
    beam: {
        ...
        summaryStreak: 'Meilleure série',
        summaryStarsOne: 'Tu as gagné {n} étoile !', summaryStars: 'Tu as gagné {n} étoiles !',
        summaryNewBest: 'Nouveau record personnel !',
