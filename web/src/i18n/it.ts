...
export const it: Translations = {
    ...
    settings: {
        ...
        showScoreHint: 'Spento: nessun punto né combo durante la missione — solo l’esercizio. Alla fine li vedi comunque. Spesso più tranquillo per i più piccoli.',
        on: 'Sì',
        off: 'No',
    ...
    duel: {
        title: 'In due',
        blurb: 'Un dispositivo, due bambini — a turno.',
        ...
        modeVersusHint: 'Ogni bambino conta per sé. Stessi esercizi, stesse possibilità.',
        playerOne: 'Bambino 1',
        playerTwo: 'Bambino 2',
