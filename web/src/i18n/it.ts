...
export const it: Translations = {
    nav: {
        home: 'Inizio', hallOfFame: 'Classifica', settings: 'Impostazioni',
        starsLabel: '{n} stelle su 3', starsLabelOne: '{n} stella su 3',
    },
    home: {
        ...
        missionLength: '{n} esercizi',
        dueToday: '{n} esercizi sono da rivedere oggi',
    ...
    misses: {
        offByOne: 'Manca solo uno. Guarda il procedimento — mostra una via più veloce del contare.',
    ...
    settings: {
        ...
        showScoreTitle: 'Mostra i punti mentre giochi',
        showScoreHint: 'Spento: nessun punto né combo durante la missione — solo l’esercizio. Alla fine li vedi comunque. Spesso più tranquillo per chi è più piccolo.',
        on: 'Sì',
        off: 'No',
    ...
    printables: {
        title: 'Da stampare',
        hint: 'Materiale per il tavolo invece che per lo schermo: carte con i puntini, griglie del dieci vuote e linee dei numeri vuote. Un dispositivo non basta per una classe intera — la carta sì.',
    ...
    tt: {
        ...
        heatmapCell: '{a} per {b} fa {answer}, {state}',
        heatmapUnseen: 'non ancora visto', heatmapLearning: 'in corso',
        heatmapDue: 'da ripassare oggi', heatmapMastered: 'saputo a memoria',
        ...
        summaryStarsEarnedOne: 'Hai guadagnato {n} stella!', summaryStarsEarned: 'Hai guadagnato {n} stelle!',
    ...
    duel: {
        title: 'In due',
        blurb: 'Un dispositivo, in due — a turno.',
        setupTitle: 'Chi gioca?',
        modeTitle: 'Come volete giocare?',
        modeTogether: '🤝 Insieme',
        modeTogetherHint: 'Un risultato per entrambi. Vi aiutate — non vince nessuno.',
        modeVersus: '⚔️ Uno contro uno',
        modeVersusHint: 'Ogni risultato conta a sé. Stessi esercizi, stesse possibilità.',
        playerOne: 'Nome 1',
        playerTwo: 'Nome 2',
        namePlaceholder: 'Nome',
        start: 'Via',
        turnOf: 'Tocca a {name}',
        yourTurn: 'Tocca a te, {name}!',
        handOver: 'Passa il dispositivo',
        ready: 'Si parte!',
        roundOver: 'Turno finito!',
        togetherResult: 'Fatto insieme',
        versusWinner: '{name} ha vinto!',
        versusDraw: 'Pareggio — pari merito!',
        correctOf: '{correct} su {total} giusti',
        again: 'Ancora',
        exit: 'Indietro',
        recordsNothing: 'Una partita in due non viene salvata — non cambia né stelle né progressi.',
    },
    surprise: {
        title: 'Sorprendimi',
    ...
    sense: {
        ...
        exitToMap: 'Torna alla mappa',
        playTitle: 'Esplora i numeri',
        playHint: 'Qui non si chiede nulla e non si conta nulla. Cambia il numero e guarda come cambia dappertutto.',
        playLess: '{n} in meno',
        playMore: '{n} in più',
        playDots: '{n} come schema di puntini',
        playFrame: '{n} nella griglia del dieci',
        playRack: '{n} sulla cornice con le perle',
        playLine: '{n} sulla linea dei numeri fino a {max}',
        playCard: 'Esplora i numeri — senza domande',
        glanceHint: 'Un’occhiata — non contare.',
        closeEnough: 'Abbastanza vicino!',
        tier: 'Livello {n}',
        help: 'Aiuto',
        helpTitle: 'Come guardare',
        helpClose: 'Avanti',
    ...
    beam: {
        ...
        summaryStarsOne: 'Hai guadagnato {n} stella!', summaryStars: 'Hai guadagnato {n} stelle!',
        summaryNewBest: 'Nuovo record personale!',
