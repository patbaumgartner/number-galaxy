...
export const translations: Record<Language, Translations> = {
    en: {
        ...
        homeInstructions: [
            ...
            'Steer your rocket with ⬅️ ➡️ arrow keys',
            'Press Space or tap 🎯 Shoot to fire at the right answer',
    ...
    de: {
        ...
        homeInstructions: [
            ...
            'Steuere deine Rakete mit den ⬅️ ➡️ Pfeiltasten',
            'Drücke Leertaste oder tippe 🎯 Schiessen für die richtige Antwort',
    ...
    it: {
        ...
        homeInstructions: [
            ...
            'Guida il tuo razzo con i tasti freccia ⬅️ ➡️',
            'Premi Spazio o tocca 🎯 Spara per la risposta giusta',
    ...
    fr: {
        ...
        homeInstructions: [
            ...
            'Pilote ta fusée avec les touches ⬅️ ➡️',
            'Appuie sur Espace ou touche 🎯 Tirer pour la bonne réponse',
